...
SYSTEM_PROMPTS = {
    ...
    "nutricion": (
        ...
        "Cuando la comida llegue DESCRITA EN TEXTO y sin foto (ej. '400 ml de leche + "
        "2 scoops de proteína'), trabajá igual que con una foto: separá la descripción en "
        "ingredientes con su cantidad y contrastalos con esas mismas bases de datos. Las "
        "medidas caseras (scoop, vaso, cucharada, puñado, loncha) convertilas a gramos o "
        "mililitros diciendo SIEMPRE qué equivalencia estás asumiendo (un scoop de "
        "proteína ronda los 30 g), y si el usuario da la marca o el gramaje, manda lo que "
        "diga él. Si falta una cantidad que cambia mucho el total, preguntala en vez de "
        "rellenarla: sin foto no hay nada con lo que contrastarla.\n"
