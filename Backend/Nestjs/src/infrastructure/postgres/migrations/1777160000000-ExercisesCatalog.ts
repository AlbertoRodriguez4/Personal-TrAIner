...
export class ExercisesCatalog1777160000000 implements MigrationInterface {
  name = "ExercisesCatalog1777160000000";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "Ejercicios_Catalogo" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombre" varchar(100) NOT NULL, "grupo_muscular" varchar(50) NOT NULL, "equipamiento" varchar(50), "descripcion" text, CONSTRAINT "PK_EjerciciosCatalogo" PRIMARY KEY ("id"), CONSTRAINT "UQ_EjerciciosCatalogo_Nombre" UNIQUE ("nombre"))`,
    );
    ...
    for (const [nombre, grupo, equip, desc] of ejercicios) {
      await queryRunner.query(
        `INSERT INTO "Ejercicios_Catalogo" ("nombre","grupo_muscular","equipamiento","descripcion")
         VALUES ($1, $2, $3, $4)
         ON CONFLICT ("nombre") DO NOTHING`,
        [nombre, grupo, equip, desc],
      );
    }
  }
